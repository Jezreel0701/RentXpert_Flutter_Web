    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // _infoRow("Property Name", apartment['Property_Name']),
            // _infoRow("Description", apartment['user_id']),
            _infoRow("Email", apartment['address']),
            _infoRow("Room Type", apartment['Room_Type']),
            _infoRow("Gender", apartment['Gender']),
            _infoRow("Valid ID", apartment['Valid_ID'])
